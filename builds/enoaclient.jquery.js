...
},{"./lib/connectors/jquery.js":4,"./lib/enoaclient":5}],3:[function(require,module,exports){
...
function jQueryConnector(){ console.log('nomi'); }
jQueryConnector.prototype._request = function(params, cb) {
	var ajax = {
		url: params.url,
		data: params.body,
		type: params.method,
...
function enoaClient(opts){
  ...
  opts.connector = new opts.connector();
  enoaClient.prototype._sendRequest = opts.connector._request;
